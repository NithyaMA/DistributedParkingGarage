...
public class ParkingGarageEntry2 implements ActionListener {
    ...
    static JFrame garageFrame= null;
	  ...
	  public ParkingGarageEntry2() throws RemoteException, NotBoundException
	  {
	...
	{
		ParkingGarageEntry2 pgc= new ParkingGarageEntry2();
