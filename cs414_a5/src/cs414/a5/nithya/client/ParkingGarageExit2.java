...
public class ParkingGarageExit2 implements ActionListener {
    ...
    static JFrame garageFrame= null;
	  ...
	  public ParkingGarageExit2() throws RemoteException, NotBoundException
	  {
		  Registry registry= LocateRegistry.getRegistry("localhost");
		  garage = (Garage) 
					registry.lookup("garageServer");
		  
		 garage.setCurrenKiosk("ex2");
	  ...
	  public void addWidgets() throws RemoteException
	  {
		 ...
		 statusLabel.setText("Garage status : " + garage.getGarageStatus());
			  ...
			  String[] garageOptions={"Exit Garage", "Stuck in garage", "Exit from menu"};
			  garageChoices= new JComboBox(garageOptions);
			 
		
		
		 
		  garageChoices.setSelectedIndex(2);
	...
	{
		ParkingGarageExit2 pgc= new ParkingGarageExit2();
