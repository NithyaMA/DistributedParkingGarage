...
public class ParkingGarageExit1 implements ActionListener {
    ...
    static JFrame garageFrame= null;
	  ...
	  public ParkingGarageExit1() throws RemoteException, NotBoundException
	  {
	...
	{
		ParkingGarageExit1 pgc= new ParkingGarageExit1();
